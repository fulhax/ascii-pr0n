...
unsigned char getclosestcolor(unsigned char r, unsigned char g, unsigned char b)
{
    ...
    {
        short reddist   = r - inputpal[i * 3];
        short greendist = r - inputpal[i * 3 + 1];
        short bluedist  = r - inputpal[i * 3 + 2];
        float dist      = reddist * reddist + greendist * greendist + bluedist * bluedist;
